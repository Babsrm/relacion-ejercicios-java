...
public class Ej04MoverPosicionArrayIzqPidiendoPos {
	...
	public static void main(String[] args) {
		...
		LibreriaFunciones.moverPosicionIzqConPos(array, rotacion);
		System.out.printf("El array rotado %d a la izquierda es: ", rotacion);
		LibreriaFunciones.mostrarVector(array);
